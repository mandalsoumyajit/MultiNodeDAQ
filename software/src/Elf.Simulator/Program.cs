...
if(a.Has("help")){Console.WriteLine("Elf.Simulator --scenario scenarios/baseline-2.json --host 127.0.0.1 --port 45100 [--nodes 2 --seconds 30 --mode counter --encoding 1] --summary sim.json");return;}
