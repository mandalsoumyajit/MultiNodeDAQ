...
if(argsMap.Has("help")){Console.WriteLine("MultiNodeDAQ.Host [--record NEW_DIRECTORY] [--address 127.0.0.1 --port 45100 --seconds 30 --interactive --no-auto-start] | --verify FILE_OR_DIRECTORY | --replay DIRECTORY --unit HEX --session HEX [--first 0 --count 1024 --output replay.csv --speed 0 --allow-incomplete] | --version");return;}
